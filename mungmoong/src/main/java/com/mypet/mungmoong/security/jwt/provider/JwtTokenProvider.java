package com.mypet.mungmoong.security.jwt.provider;
...
import com.mypet.mungmoong.security.jwt.constants.SecurityConstants;
...
public class JwtTokenProvider {
    ...
    public String createToken(String username, List<String> roles) throws Exception {
        ...
        String jwt = Jwts.builder()
                ...
                .claim("nickname", nickname)                              // 클레임 설정: 사용자 닉네임
