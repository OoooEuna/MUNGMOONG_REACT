package com.mypet.mungmoong.imgfile.api;
...
@Slf4j
@RestController
@RequestMapping("/api/imgfile")
public class ImgFileApiController {

    private final ImgFileService imgFileService;

    @Autowired
    public ImgFileApiController(ImgFileService imgFileService) {
