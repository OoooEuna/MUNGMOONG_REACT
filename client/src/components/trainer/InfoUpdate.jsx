...
const InfoUpdate = ({ trainer, careerList, newCareerList, certificateList, addCareerInput, addCertificateInput, handleCareerChange, handleNewCareerChange, handleContentChange, handleCertificateChange, handleDeleteCareer, onSubmit }) => {
  return (
              ...
              <tr>
                ...
                <td id="career">
                  {careerList.map((career, index) => (
                    <div key={career.no} className="d-flex align-items-center">
                      <input
                        type="text"
                      ...
                      />
                      <button type="button" className="btn btn-danger ml-2" onClick={() => handleDeleteCareer(career.no)}>
