    ...
    <div className='container'>
      <div className="inner">
        ...
        <div className="btn-box">
          <Link to="/api/admin/admin_board" className='btn btn-primary btn-lg listBtn'>목록</Link>
          <button className='btn btn-secondary btn-lg updateBtn' onClick={handleDelete}>삭제</button>
          <button className='btn btn-secondary btn-lg updateBtn' onClick={onSubmit}>수정</button>
        </div>
      </div>
    </div>
  )
